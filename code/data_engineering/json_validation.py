...
path = r"D:\Proyectos de codigo\python\code\data_sources\transacciones.json"
...
print("Validating key 'address':", validate_key_exists(data, "address"))  # Expected to fail

print("\nValidating that 'age' is a non-negative number:", validate_positive_number(data.get("age", -1)))
print("Validating that 'age' is a positive integer:", validate_positive_integer(data.get("age", -1)))

print("\nValidating that 'name' is a non-empty string:", validate_non_empty_string(data.get("name", "")))
print("Validating that 'email' is a valid email:", validate_email(data.get("email", "")))

print("\nValidating that 'scores' has 3 elements:", validate_list_length(data.get("scores", []), 3))
print("Validating that 'birthdate' is in YYYY-MM-DD format:", validate_date(data.get("birthdate", "")))
