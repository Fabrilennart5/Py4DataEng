    ...
    "properties": {
        ...
        "direccion": {
            ...
            "properties": {
                ...
                "codigo_postal": {"type": "string", "pattern": "^[0-9]{5}$"}  # Must be 5 digits
            },
            "required": ["calle", "ciudad", "codigo_postal"]  # These fields are mandatory
        }
    },
...
json_file_path = r"D:\Proyectos de codigo\python\code\data_sources\student.json"
